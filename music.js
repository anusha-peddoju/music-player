...
let songs=[
{songname:"Hoyna Hoyna",filepath:"/home/anusha318/Music/1.mp3"},
{songname:"Maate vinadhuga",filepath:"/home/anusha318/Music/2.mp3"},
{songname:"Thattukolede",filepath:"/home/anusha318/Music/3.mp3"},
{songname:"karma theme",filepath:"/home/anusha318/Music/4.mp3"},
{songname:"Thuli Thuli",filepath:"/home/anusha318/Music/5.mp3"},
{songname:"mehabooba",filepath:"/home/anusha318/Music/6.mp3"},
{songname:"Amma song",filepath:"/home/anusha318/Music/7.mp3"},
{songname:"Lollipop",filepath:"/home/anusha318/Music/8.mp3"}
]
...
audioElement.addEventListener('timeupdate',() => {
    ...
    if(progress==100)
    {
        ...
        songindex+=1;
        audioElement.src=`/home/anusha318/Music/${(songindex)}.mp3`;
        audioElement.play();
        audioElement.currentTime=0;
        makeplay();
        music();
...
element.addEventListener('click',()=>
{
    ...
    /*if(((audioElement.paused) && (audioElement.currentTime==0))||(!(audioElement.paused)&& (audioElement.currentTime==0)))
    {
        element.classList.remove("fa-play");
        element.classList.add("fa-pause");
        masterplay.classList.remove("fa-play");
        masterplay.classList.add("fa-pause");
        audioElement.src=`/home/student/Music/${(songindex)}.mp3`;
        audioElement.currentTime=0;
        m.innerText=songs[songindex-1].songname;
        audioElement.play();
        g.style.opacity=1;
